...
{
    public class EducationModelConfiguration : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<Education> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<Education>("Educations").EntityType;
            return model;
        }
