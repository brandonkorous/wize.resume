...
{
    public class ExperienceItemModelConfiguration : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<ExperienceItem> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<ExperienceItem>("ExperienceItems").EntityType;
            return model;
        }
