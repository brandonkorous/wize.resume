...
{
    public class ExperienceTagModelConfiguration : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<ExperienceTag> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<ExperienceTag>("ExperienceTags").EntityType;
            return model;
        }
