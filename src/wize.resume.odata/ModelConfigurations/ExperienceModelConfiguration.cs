...
{
    public class ExperienceModelConfiguration : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<Experience> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<Experience>("Experiences").EntityType;
            return model;
        }
