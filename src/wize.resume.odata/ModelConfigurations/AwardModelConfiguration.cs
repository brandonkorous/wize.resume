...
{
    public class AwardModelConfiguration : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<Award> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<Award>("Awards").EntityType;
            return model;
        }
